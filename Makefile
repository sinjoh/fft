...
ACLOCAL = ${SHELL} '/home/kian/Libaries/fftw-3.3.10/missing' aclocal-1.16
ALLOCA = 
ALTIVEC_CFLAGS = 
AMTAR = $${TAR-tar}
...
AR = ar
AS = as
AUTOCONF = ${SHELL} '/home/kian/Libaries/fftw-3.3.10/missing' autoconf
AUTOHEADER = ${SHELL} '/home/kian/Libaries/fftw-3.3.10/missing' autoheader
AUTOMAKE = ${SHELL} '/home/kian/Libaries/fftw-3.3.10/missing' automake-1.16
AVX2_CFLAGS = 
AVX512_CFLAGS = 
AVX_128_FMA_CFLAGS = 
AVX_CFLAGS = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/kian/Libaries/fftw-3.3.10/missing' makeinfo
MANIFEST_TOOL = :
...
VERSION = 3.3.10
VSX_CFLAGS = 
abs_builddir = /home/kian/Libaries/fftw-3.3.10
abs_srcdir = /home/kian/Libaries/fftw-3.3.10
abs_top_builddir = /home/kian/Libaries/fftw-3.3.10
abs_top_srcdir = /home/kian/Libaries/fftw-3.3.10
ac_ct_AR = ar
ac_ct_CC = mpicc
ac_ct_DUMPBIN = 
ac_ct_F77 = 
...
install_sh = ${SHELL} /home/kian/Libaries/fftw-3.3.10/install-sh
...
pdfdir = ${docdir}
prefix = /home/kian/Libaries/FFTW
...
#GENFFT = genfft
#EXTRA_libfftw3_la_DEPENDENCIES = assert-shared-version-info
...
9:10:6  $(ENVIRONMENT_LIBFFTW3_LDFLAGS)


# cannot use -no-undefined since dependent on libquadmath
#libfftw3_la_LDFLAGS = -version-info 9:10:6 $(ENVIRONMENT_LIBFFTW3_LDFLAGS)
pkgconfigdir = $(libdir)/pkgconfig
pkgconfig_DATA = fftw3.pc
cmakedir = $(libdir)/cmake/fftw3
cmake_DATA = FFTW3Config.cmake FFTW3ConfigVersion.cmake
WISDOM_DIR = /etc/fftw
WISDOM = wisdom
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(cmakedir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
uninstall-am: uninstall-cmakeDATA uninstall-libLTLIBRARIES \
	uninstall-pkgconfigDATA
...
#	current=`echo 9:10:6 | cut -d: -f1`;	\
#	age=`echo 9:10:6 | cut -d: -f3`;		\
#	major=3;						\
